...
const PROFILE_API = 'http://localhost:5000/api/auth';
...
function setAvatarImg(url) {
    ...
    if (!avatarEl) return;
    avatarEl.innerHTML = `<img src="${url}?t=${Date.now()}" alt="Profile photo" onerror="this.parentElement.innerHTML='<svg viewBox=\\'0 0 24 24\\' fill=\\'none\\' stroke=\\'currentColor\\' stroke-width=\\'1.5\\' width=\\'52\\' height=\\'52\\' style=\\'opacity:0.4\\'><path d=\\'M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2\\'/><circle cx=\\'12\\' cy=\\'7\\' r=\\'4\\'/></svg>'">`;
}
